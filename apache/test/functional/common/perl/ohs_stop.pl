...
#
#    NAME
#      ohs_stop.pl - <one-line expansion of the name>
#
#    DESCRIPTION
#      Stop an OHS instance
#      Usage:  ohs_stop.pl -ohs <ohsName>
#     
#    NOTES
...
if ($INSTALL_TYPE eq "standalone") {
    $script = $scriptBase . "ohs_stop_standalone.py";
} else {
    $script = $scriptBase . "ohs_stop.py";
}
...
print "=============================\n";
print "Shutting down OHS instance: $OHS_NAME\n\n$cmd\n\n";
print "=============================\n";
